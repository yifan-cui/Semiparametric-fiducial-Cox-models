...
nparts =10 #set to 1 for 10, 20, and 5 for 30, and 10 40
...
#save(mse1,mse2,cov1,cov2,length1,length2,flag,length.record,file = "3n20.RData")
save.image(file=paste("cox3n",nsample,"p",ipart,".RData",sep=""))